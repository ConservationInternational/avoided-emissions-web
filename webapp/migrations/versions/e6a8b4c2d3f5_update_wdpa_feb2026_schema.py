...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("site_pid", sa.Integer(), nullable=True),
        ...
        sa.Column("metadataid", sa.String(length=100), nullable=True),
        sa.Column("prnt_iso3", sa.String(length=10), nullable=True),
